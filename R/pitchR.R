...
#'  \item{ERA/Barrel Percent	}{ Pitcher ERA divided by barrel percent, also a luck-reversion variable attempting to connect the amount of hard contact given up with the amount of runs allowed}
#'  \item{ERA/Hard Hit Percent	}{ Pitcher ERA divided by hard hit percent, yet another luck-reversion variable similar to ERA/barrel percent}
#' }
#' 
#' 
