...
Here's a breakdown of how much missing data we have by variable. We opted to keep observations with missing values in order to keep a full version of the salary data.
