...
```{r pitcher_velocity, warning = FALSE, message = FALSE, echo = FALSE, out.width='75%', fig.retina=2}
...
```{r pitcher_woba, warning = FALSE, message = FALSE, echo = FALSE, out.width='75%', fig.retina=2}
pitcher <- pitchR %>%
  group_by(name) %>%
